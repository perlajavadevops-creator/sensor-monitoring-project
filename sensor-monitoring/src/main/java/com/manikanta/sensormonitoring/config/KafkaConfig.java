...
public class KafkaConfig {
    ...
    public ConsumerFactory<String, SensorEvent> consumerFactory() {
        ...
        config.put(JsonDeserializer.TRUSTED_PACKAGES, "com.manikanta.sensormonitoring.dto");
        config.put(JsonDeserializer.VALUE_DEFAULT_TYPE, SensorEvent.class.getName());
